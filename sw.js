...
const CACHE = "lz-brief-v8";
const SHELL = [
  "./", "./index.html", "./manifest.webmanifest",
  "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"
];
/* The OCR pack (Tesseract.js engine, WASM core, English model — about 7 MB)
   sits in its own cache so it survives app-shell version bumps and is fetched
   once. Cached best-effort at install; if the download fails the app still
   installs and the pack is cached the first time "Read a screen photo" runs. */
